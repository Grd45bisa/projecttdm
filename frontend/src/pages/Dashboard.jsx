  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        // Create API base URL - makes it easier to change in development/production
        ...
        const [
          ...
          axios.get(`${API_BASE_URL}/sentimen/produk-count`).catch(() => {
            // Fallback to product count
            return axios.get(`${API_BASE_URL}/produk/count`);
          }),
          
          // Fetch sentiment stats
          axios.get(`${API_BASE_URL}/sentimen/stats`),
          
          // Fetch recent reviews (get more to allow for random selection)
          axios.get(`${API_BASE_URL}/sentimen/recent`),
          
          // Fetch top keywords by sentiment
          axios.get(`${API_BASE_URL}/sentimen/top-keywords`),
          
          // Fetch analysis recommendation
          axios.get(`${API_BASE_URL}/sentimen/analysis`),
